...
<div class="container">
    <form class="container" role="form" method="POST" action="{{ url('/editpostveg') }}">
        ...
        <div class="row">
          <div class="col-md-offset-2 col-md-4">
            <div class="form-group text-center">
              ...
              <br>
              <input type="text" name="pname" id="pname" class="form-control" value="{{ $products->name }}">
    ...
    <div class="row">
      <div class="col-md-offset-2 col-md-4">
        <div class="form-group text-center">
          ...
          <br>
          <input type="date" id="startdate" class="form-control" name="pdate" value="{{ $products->date }}">
        </div>
      </div>
      <div class="col-md-4">
      <div class="form-group text-center">
        ...
        <br>
        <input type="time" id="starttime" class="form-control" name="ptime" value="{{ $products->time }}">
      </div>
    </div>
  </div>
      <div class="row">
        <div class="col-md-offset-2 col-md-4">
          <div class="form-group text-center">
            ...
            <input type="text" id="price" class="form-control" name="price"  value="{{ $products->base_price }}">
          </div>
        </div>
        <div class="col-md-4">
          <div class="form-group text-center">
            <label>Quantity</label><br>
            <input type="number" id="quantity" class="form-control" name="pquantity" value="{{ $products->quantity }}">
          </div>
        </div>
      </div>
